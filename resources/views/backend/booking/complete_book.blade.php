                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-8 border-right py-0">
                            <h3 class="my-1">Complete Booking Ride time over</h3>
                        </div>
                        <div class="col">
                            <a href="{{route('admin.complete.book','time')}}" class="btn btn-sm btn-primary">Not time
                                over</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        @foreach($stopover as $stopovers)
                            ...
                            ?>
                            @if(seat($stopovers->going,$stopovers->target,$stopovers->post_id) < 1)
                                <div class="col-12">
        ...
        @if(isset($id))
            <div class="card mt-2">
                <div class="card-header">
                    <div class="row">
                        <div class="col-8 border-right py-0">
                            <h3 class="my-1">Complete Booking Ride time not over</h3>
                        </div>
                        <div class="col">
                            <a href="{{route('admin.complete.book')}}" class="btn btn-sm btn-primary">Time
                                over</a>
                        </div>
                    </div>
                </div>
